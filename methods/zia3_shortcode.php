...
if ( ! defined( 'ABSPATH' ) ) exit;	
    ...
    $atts = shortcode_atts(array('id' => '','fade' => '2000','overlay' => '', 'type' => '1', 'arrows' => 'yes','poster' => 'yes','delay' => '4000','autoplay' => 'yes', 'random' => '', 'link_title'=> 'Enter Here', 'link' => 'http://zia3.com', 'slogan' => 'slogan', 'slogan_link' => 'slogan_link'), $atts);
...
HEREDOC;
    ...
    if( $slogan || $slogan_link ){
    	$replacement .= '<p><a title="'.$slogan.'" style="color: rgb(255,255,255)" href="'.$slogan_link.'">'.$slogan.'</a></p>';
    } else {
